...
actual = mean_var_std([2,6,2,8,4,0,1,5,7])
...
print(expected)
  ...
  #     actual = mean_var_std([9,1,5,3,3,3,2,9,0])
  ...
  #     self.assertRaisesRegex(ValueError, "List must contain nine numbers.", mean_var_std, [2,6,2,8,4,0,1,])
